...
import "./CallPageFooter.css"; // Ensure this path is correct and the SCSS file is in place.
  ...
  return (
    <div className="footer-item">
      ...
      <div className="center-item">
        <div
          className={`icon-block ${!isAudio ? "red-bg" : ""}`} // Fixed null to empty string for falsy case
